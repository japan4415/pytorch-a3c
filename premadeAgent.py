    ...
    def getAction(args,statusA):
        ...
        if statusA[0][2] == 255 and statusA[0][3] == 255:
            if statusA[0][1] < statusA[3][1]:
                ...
                diff0 = statusA[0][1] - status[3][1]
            if statusA[0][1] < statusA[4][1]:
                diff1 = statusA[0][1] + args.field_size - statusA[4][1]
            elif statusA[0][1] > statusA[4][1]:
                diff1 = 0
            elif statusA[0][1] > statusA[4][1]:
                diff1 = statusA[0][1] - status[4][1]
            if diff0 >= diff1:
                self.targetGoal = 1
            else:
                self.targetGoal = 1
        # →
            ...
            if statusA[0][0] > statusA[3][0]:
                ...
                diff0 = status[3][0] - statusA[0][0]
            if statusA[0][0] > statusA[4][0]:
                diff0 = args.field_size - statusA[0][1] + statusA[4][0]
            elif statusA[0][0] > statusA[4][0]:
                diff1 = 0
            elif statusA[0][0] < statusA[4][0]:
                diff1 = status[4][0] - statusA[0][0]
            if diff0 >= diff1:
                self.targetGoal = 1
            else:
                self.targetGoal = 1
        # ↓
            ...
            if statusA[0][1] > statusA[3][1]:
                ...
                diff0 = status[3][1] - statusA[0][1]
            if statusA[0][1] > statusA[4][1]:
                diff1 = args.field_size - statusA[0][1] + statusA[4][1]
            elif statusA[0][1] > statusA[4][1]:
                diff1 = 0
            elif statusA[0][1] < statusA[4][1]:
                diff1 = status[4][1] - statusA[0][1]
            if diff0 >= diff1:
                self.targetGoal = 1
            else:
                self.targetGoal = 1
        # ←
            ...
            if statusA[0][0] < statusA[3][0]:
                ...
                diff0 = statusA[0][0] - status[3][0]
            if statusA[0][0] < statusA[4][0]:
                diff0 = args.field_size + statusA[0][1] - statusA[4][0]
            elif statusA[0][0] > statusA[4][0]:
                diff1 = 0
            elif statusA[0][0] > statusA[4][0]:
                diff1 = statusA[0][0] - status[4][0]
            if diff0 >= diff1:
                self.targetGoal = 1
            else:
                self.targetGoal = 1
